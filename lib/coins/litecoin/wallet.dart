  ...
  Future<void> handleUR(final BuildContext context, final URQRData ur) async {
    switch (ur.tag) {
      case 'psbt' || '':
        ...
        // final psbt = /* works: bluewallet, litecoin 4 test tx */ await PartiallySignedTransaction.fromString("");
        // final psbt = /* works: bluewallet, litecoin 4 test tx (2) */ await PartiallySignedTransaction.fromString("",);
