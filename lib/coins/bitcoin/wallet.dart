  ...
  Future<void> handleUR(final BuildContext context, final URQRData ur) async {
    switch (ur.tag) {
      case 'psbt' || '':
        ...
        // final psbt = /* works: bluewallet, bitcoin 4 test tx, doesnt sign */ await PartiallySignedTransaction.fromString("");
        final psbt = /* works: bluewallet, bitcoin 4 test tx */
