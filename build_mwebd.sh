...
go build -buildmode=c-shared -buildvcs=false -o ${ANDROID_OUT}/x86_64/libmweb.so .
...
go build -buildmode=c-shared -buildvcs=false -o ${ANDROID_OUT}/arm64-v8a/libmweb.so .
...
go build -buildmode=c-shared -buildvcs=false -o ${ANDROID_OUT}/armeabi-v7a/libmweb.so .
cd ../
